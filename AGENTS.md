...
This file is the quick-reference operating contract for assert-matches-kotlin. The longer
...
assert-matches-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`assert_matches`](https://crates.io/crates/assert_matches). Upstream Rust is the behavioral oracle while the
