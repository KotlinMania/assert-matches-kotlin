...
kotlin {
    ...
    val xcf = XCFramework("AssertMatches")
    ...
    swiftExport {
        moduleName = "AssertMatches"
        flattenPackage = "io.github.kotlinmania.assertmatches"
    }

    android {
        namespace = "io.github.kotlinmania.assertmatches"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "assert-matches-kotlin", version.toString())

    pom {
        name.set("assert-matches-kotlin")
        description.set("Kotlin Multiplatform port of murarth/assert_matches - Asserts that a value matches a pattern")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/assert-matches-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/assert-matches-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/assert-matches-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/assert-matches-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAssertMatchesXCFramework",
    "assembleAssertMatchesDebugXCFramework",
    "assembleAssertMatchesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseIosFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugMacosFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseMacosFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugTvosFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseTvosFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugWatchosFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseWatchosFatFrameworkForAssertMatchesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAssertMatchesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAssertMatchesXCFramework",
